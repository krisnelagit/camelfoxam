...
//                }, margins);
    ...
    <body>
        ...
        <a href="#" onclick="showhistory()" onclick="" class="view button-001"><img src="images/wallet33.png" width="15" height="13"/>&nbsp;History</a>  <a href="sendMailInvoice?invoiceid=${param.invoiceid}" class="view button-001">Goto Send Mail</a>  <a href="invoiceMasterLink" class="view button-001">Back</a><a href="#" class="view button-001" onclick="printContent('printdiv')">Print</a>
