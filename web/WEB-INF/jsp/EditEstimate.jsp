        ...
        <SCRIPT language="javascript">
            ...
            function addRow(tableID) {
                                if (tableID === "dataTable") {
                                    $('#' + tableID + '').append('<tr><td align="left" valign="top"><INPUT type="checkbox" class="test" name="chk"/><input type="hidden" name="part_type" value="part" /><input type="hidden" name="newpartlistid" id="partlistid" /></td><td align="left" valign="top"><input name="newpartname" type="text" id="partname" /></td><td align="left" valign="top"> <select name="fivePrice" class="fivePrice" style="width: 100px" onchange="iambatman(this)"><option selected="" disabled="">--select--</option></select></td><td align="left" valign="top"><textarea name="newdescription" maxlength="1000" id="textfield2">description..</textarea></td><td align="left" valign="top"><input name="newquantity" type="number" class="quantity" style="width: 60px" value="1" onchange="calculatebalance(this)" onclick="calculatebalance(this)" /></td><td align="left" valign="top"><input name="newpartrs" style="width: 60px" type="number" step="0.01" class="sellingprice" onchange="calculatebalance(this)" onclick="calculatebalance(this)" /></td><td align="left" valign="top"><input name="newlabourrs" style="width: 60px" type="number" step="0.01" id="textfield6" /></td><td align="left" valign="top"><input name="newtotalpartrs" readonly="" type="number" class="itemtotal" style="width: 100px"/></td><td align="left" valign="top"><a onClick="deleteRow1(this)"><img src="images/delete.png" width="16" height="17" /></a></td></tr>');
                                } else {
            ...
            <TABLE id="dataTable" border="0" class="CSSTableGenerator">
                ...
                <c:forEach var="ob" items="${partlistdtls}">
                    <tr>
                        ...
                        <td align="left" valign="top"><input name="quantity" type="number" class="quantity tabspecific" style="width: 60px" value="${ob.quantity}" onchange="calculatebalance(this)" onclick="calculatebalance(this)" /></td>
